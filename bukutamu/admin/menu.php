<div id="sidemenu">
<ul id="menutitles">
  <li class="menutitle"><span>ADMIN</span>
    <ul class="menulinks">
...
?>      
  ...
  <li class="menutitle"><span>MESSAGES</span>
    <ul class="menulinks">
  ...
  <li class="menutitle"><span>SETTINGS</span>
    <ul class="menulinks">
      ...
      <li><a href="<?php echo $this->SELF. '?action=settings&amp;panel=pwd&amp;gbsession=' . $this->gbsession . '&amp;uid='.$this->uid; ?>" style="height: 34px;">change password</a></li>
    </ul>
  </li>
  <li class="menutitle"><span>INFO</span>
    <ul class="menulinks">
      ...
      <li><a href="<?php echo $this->SELF. '?action=info&amp;section=phpinfo&amp;gbsession=' . $this->gbsession .'&amp;uid=' . $this->uid ?>">php info()</a></li>
    </ul>
  </li>
</ul>
</div>