...
<body>
<!-- Last modified Tue, 11 October 2011 20:25:10 GMT -->
...
?>
  ...
  <tr>
    ...
    <td valign="top" class="righttd">
        <input type="text" name="allowed_tags" value="<?php echo $this->VARS['allowed_tags']; ?>" size="30" maxlength="60" class="input"><br>
    ...
    <td valign="top" class="lefttd"> <b>AGCodes</b><br>
      <small>AGCode is a variation on the HTML tags you may already be familiar with.
       ...
       You can use AGCode even if HTML is not enabled for the guestbook.<br>
          ...
          <p><small><strong>If Lazarus keeps displaying YouTube urls posted using Flash AGcode as a link then select this option to have Lazarus use the full YouTube url when getting the data for the Flash file and not the short version.</strong><br />
  ...
  <tr>
    <td valign="top" class="lefttd"> <b>Guestbook URL</b><br>
      <small>This is the actual address of your guestbook. If you are using the guestbook as it is then this should match the base url above. If you are using the guestbook as a module this should be set to the url of the guestbook for example (http://yoursite.com/modules.php?name=Guestbook).
      If you have integrated Lazarus in to your website using the gbinclude file then this is set to the page you have integrated it in to.</small></td>
    <td valign="top" class="righttd">
        <input type="text" name="laz_url" value="<?php echo $this->VARS['laz_url']; ?>" size="30" class="input">
    </td>
  </tr>  
  <tr>
...
<table>
  ...
  <tr>
    ...
    <td valign="top" class="righttd"><input type="text" name="admin_mail" value="<?php echo $this->VARS['admin_mail']; ?>" size="30" maxlength="200" class="input"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top" class="righttd">
      <textarea rows="5" cols="30" wrap="virtual" name="notify_mes" id="notify_mes" class="input"><?php echo $this->VARS['notify_mes']; ?></textarea>
  ...
  <tr>
    <td valign="top" class="lefttd"><b>SMTP Settings</b><br>
      ...
      Please note that the SMTP function of Lazarus Guestbook may not work with all SMTP servers.
    ...
    <td valign="top" class="righttd">
      <small>Server:</small><input type="text" name="smtp_server" value="<?php echo $this->VARS['smtp_server']; ?>" size="30" maxlength="100" class="input"><br />
      <small>Username:</small><input type="text" name="smtp_username" value="<?php echo $this->VARS['smtp_username']; ?>" size="30" maxlength="100" class="input"><br />
      <small ondblclick="setMask();">Password:</small><input type="password" id="smtp_password" name="smtp_password" value="<?php echo $this->VARS['smtp_password']; ?>" size="30" maxlength="100" class="input"><br />
...
<table>
  ...
  <tr>
    <td valign="top" class="lefttd"> <b>Anti Bot Test</b><br>
      <small>You can require that users have to enter the randomly generated characters from an image or answer a question you have set before their post gets added.<br>
			If you select the question method then simply specify <b>BOTH</b> the question and the answer in their respective boxes on the right. 
    ...
    <td valign="top" class="righttd">
        ...
        if (!extension_loaded('gd')) { echo ' disabled'; } ?>> Use image verification (CAPTCHA).<br>
  ...
  <tr>
    <td valign="top" class="lefttd"> <b>Guestbook Comment</b><br>
      ...
      You can also use CAPTCHA to prevent spam. This is instead of the password.<br>
      You can totally disable comments if you wish or set them so they can only be posted from Easy Admin. If you disable them then old comments are not shown.
      If set to admin only then old comments are still shown.</small>
		<p><small><strong>Comments:</strong> <input type="radio" value="0" name="disablecomments"<?php if ($this->VARS['disablecomments'] == 0) {echo ' checked';}?> id="disablecomments"> <label for="disablecomments">Enabled</label> <input type="radio" value="1" name="disablecomments"<?php if ($this->VARS['disablecomments'] == 1) {echo ' checked';}?> id="disablecomments"> <label for="disablecomments">Disabled</label> <input type="radio" value="2" name="disablecomments"<?php if ($this->VARS['disablecomments'] == 2) {echo ' checked';}?> id="disablecomments"> <label for="disablecomments">Admin Only</label></small></p>
      </td>
    <td valign="top" class="righttd">
        ...
        Use image verification (CAPTCHA)<br>
  ...
  <tr>
    ...
    <td valign="top" class="righttd">
        ...
        Image dimension:<br>
        Width: <input type="text" name="captcha_width" value="<?php echo $this->VARS['captcha_width']; ?>" size="3" maxsize="3"> &nbsp; Height: <input type="text" name="captcha_height" value="<?php echo $this->VARS['captcha_height']; ?>" size="3" maxsize="3">
    </td>
  </tr>  
  <tr>
  ...
  <tr>
    <td valign="top" class="lefttd">
      <b>Banned IP?</b><br>
        ...
        (eg. 127.0.0.1/24) which makes it easier to block whole ranges of IP addresses and even block complete countries by getting the relevant CIDR 
        codes from a site such as <a href="http://www.countryipblocks.net/" target="_blank">Country IP Blocks</a>.</small>
        <center>
