...
?>
  <table>
    ...
    <tr> 
      <td class="righttd"><p><b>Your include code:</b> <input type="text" value="<?php echo '&lt;?php include(\''.preg_replace("/admin$/", '', dirname(__FILE__)).'gbinclude.php\'); ?&gt;'; ?>" size="96" class="input"></p>
  ...
  <table>
    ...
    <tr> 
      ...
      <td valign="top" class="righttd" style="width: 280px;"> 
        <input type="text" name="pbgcolor" value="<?php echo $this->VARS['pbgcolor']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd">
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="link_color" value="<?php echo $this->VARS['link_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="text_color" value="<?php echo $this->VARS['text_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="laz_top_font_color" value="<?php echo $this->VARS['laz_top_font_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="top_link_color" value="<?php echo $this->VARS['top_link_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="laz_top_num_color" value="<?php echo $this->VARS['laz_top_num_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="tb_hdr_color" value="<?php echo $this->VARS['tb_hdr_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="tb_text" value="<?php echo $this->VARS['tb_text']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr>    
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="tb_bg_color" value="<?php echo $this->VARS['tb_bg_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      <td class="lefttd"> <b>First Alternating Table Column Color</b><br>
        <small>Default - #FFFFFF</small></td>
      <td class="righttd" valign="top"> 
        <input type="text" name="tb_color_1" value="<?php echo $this->VARS['tb_color_1']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="tb_color_2" value="<?php echo $this->VARS['tb_color_2']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      <td class="lefttd"> <b>Search Box Background Color</b><br>
        <small>Default - #FFFFFF</small></td>
      <td class="righttd" valign="top"> 
        <input type="text" name="search_bg_color" value="<?php echo $this->VARS['search_bg_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="search_font_color" value="<?php echo $this->VARS['search_font_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr> 
      ...
      <td class="righttd" valign="top"> 
        <input type="text" name="input_error_color" value="<?php echo $this->VARS['input_error_color']; ?>" size="10" maxlength="20" class="input">
      </td>
      <td class="displaytd"> 
    ...
    <tr>
      <td class="lefttd" colspan="3">
        ...
        <div style="overflow: auto; border: 1px solid #000; padding: 5px; margin: 2px; background-color: #FFF;">
        <pre>
.lazTop a, .lazTop a:visited, .lazTop a:active { color: <?php echo $this->VARS['top_link_color']; ?>; }
.lazTop table a, .lazTop table a:visited, .lazTop table a:active { color: <?php echo $this->VARS['link_color']; ?>; }        
.font1 { font-family: <?php echo $this->VARS['font_face']; ?>; font-size: <?php echo $this->VARS['tb_font_1']; ?>; color: <?php echo $this->VARS['text_color']; ?>; }
.font2 { font-family: <?php echo $this->VARS['font_face']; ?>; font-size: <?php echo $this->VARS['tb_font_2']; ?>; color: <?php echo $this->VARS['text_color']; ?>; }
.font3 { font-family: Arial, Helvetica, sans-serif; font-size: 7.5pt; color: <?php echo $this->VARS['text_color']; ?>; font-weight: bold; }
.lazTop { background: <?php echo $this->VARS['pbgcolor']; ?>; font-family: <?php echo $this->VARS['font_face']; ?>; font-size: <?php echo $this->VARS['tb_font_2']; ?>; color: <?php echo $this->VARS['laz_top_font_color']; ?>; }
.lazTopNum { color: <?php echo $this->VARS['laz_top_num_color']; ?>; font-weight:bold; }
.select { font-family: <?php echo $this->VARS['font_face']; ?>; font-size: 9pt; }
.input { font-family: <?php echo $this->VARS['font_face']; ?>; font-size: 9pt; }
.gbsearch { font-family: <?php echo $this->VARS['font_face']; ?>; font-size: <?php echo $this->VARS['tb_font_1']; ?>; color: <?php echo $this->VARS['search_font_color']; ?>; background: <?php echo $this->VARS['search_bg_color']; ?>; }
        </pre>
        </div>
      </td>
    </tr>
